...
QT_BEGIN_NAMESPACE
class QCocoaEGLStaticContext
{
    Q_DISABLE_COPY_MOVE(QCocoaEGLStaticContext)

public:
    static QCocoaEGLStaticContext *create(QWindowsOpenGLTester::Renderers preferredType);
    ~QCocoaEGLStaticContext() override;
...
class QCocoaEGLContext : public QANGLEContext, public QWindowsOpenGLContext
{
public:
...
private:
    QCocoaEGLStaticContext *m_staticContext;
};
